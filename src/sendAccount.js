...
async function getGovStaking() {
  ...
  const govStaking = new ethers.Contract("0xEaed1D41A587f7e2821080829013e352cEc91d75", abi.abi, wallet);
  return govStaking;
}
...
async function execute() {
  ...
  try{
    const tx = await govStaking.deposit({value : '1000000000000000000',gasPrice:ethers.utils.parseUnits('101','gwei')});
